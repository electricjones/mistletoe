...
// Only modified to comply with php8.1
/*
...
class CronSchedule
{
    ...
    private array $_minutes = array();
    private array $_hours = array();
    private array $_daysOfMonth = array();
    private array $_months = array();
    private array $_daysOfWeek = array();
    private array $_years = array();

    // The original cron specification in compiled form.
    private array $_cronMinutes = array();
    private array $_cronHours = array();
    private array $_cronDaysOfMonth = array();
    private array $_cronMonths = array();
    private array $_cronDaysOfWeek = array();
    private array $_cronYears = array();

    // The language table
    private array|false $_lang = FALSE;
     ...
     * @throws Exception
     */
    private function cronInterpret($specification, int $rangeMin, int $rangeMax, $namedItems, string $errorName): array
    {
